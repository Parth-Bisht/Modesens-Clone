...
function Navbar() {
 ...
 const { isAuth, setIsAuth } = useContext(AuthContext);
  return (
    ...
    <div className="logo"><img src="https://cdn.modesens.com/static/img/20190228newlogo-black.svg" alt=""></img></div>
    <div className="links">
        <Link to='women' onMouseEnter={()=>{
            let d="women";
           setMenu(<Data r={d}/>)
        }} onMouseLeave ={()=>{setMenu("")}}>WOMEN </Link>
        <Link to='men'
        onMouseEnter={()=>{
            let d="men";
