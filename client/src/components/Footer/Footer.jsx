    ...
    return(
        ...
        <div className={style.mainbox}>
            ...
            <div className={style.customercare}>
                ...
                <a href="https://modesens.com/size-guide/"> Contact Us / Feedback</a> <br />
            ...
            <div className={style.News}>
                ...
                <form onSubmit={handleSubmit}>
                    <input onChange={handleChange} className={style.email} type="text" name="email" placeholder="Email Address"  id="email"/>
                    <div className={style.men_women}>
                        <input onChange={(e)=>{
                            const setGender=e.target.value;
                            setformData({...formData,gender:setGender})
                        }} type="radio" name="Women's" className={style.Women} value={"Women's"} /> &nbsp;
                        Women's  &nbsp;
                        <input onChange={(e)=>{
                            const setGender=e.target.value;
                            setformData({...formData,gender:setGender})
                        }} type="radio" name="Men's" className={style.Men} value={"Men's"} /> &nbsp; 
                        Men's  &nbsp;
                    </div>
        ...
        <div className={style.contacticons}>
            <div className={style.leftside}>
                <img src="https://cdn.modesens.com/static/img/20180905footer_logo.svg" alt="f" />
                <p>© 2022, ModeSens Inc</p>
            </div>

            <div className={style.rightside}>
             
                   <img src="https://cdn.modesens.com/static/img/20181008footer-pit.svg"
                    alt="y" className={style.print}/>
            
                    <img src="https://cdn.modesens.com/static/img/20181008footer-tt.svg"
                     alt="u" className={style.print}  />

                    <img src="https://cdn.modesens.com/static/img/footer-p.svg" alt="u"  className={style.print1}  />
               
                    <img src="https://cdn.modesens.com/static/img/footer-fb.svg" alt="k"  className={style.print1} />
                    <img src="https://cdn.modesens.com/static/img/footer-wb.svg" alt="l"  className={style.print1} />
                    <img src="https://cdn.modesens.com/static/img/footer-wx.svg" alt="j"  className={style.print1} />
