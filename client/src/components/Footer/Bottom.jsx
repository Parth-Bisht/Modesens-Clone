...
const Bottom = () => {
        ...
        <div>
            ...
            <div className={style.wrapper}>
                ...
                <div className={style.right}>
                    ...
                    <a href="https://addons.mozilla.org/en-GB/firefox/addon/modesens-shopping-assistant/"
                     target="_blank" rel="noreferrer">
                    {" "}
                    <br />
                    <br />
    ...
    <p className={style.botton_p}>When you follow our links to visit a brand or retailer’s website or make a purchase, ModeSens may earn a commission.</p>
    </div >
  )
}
