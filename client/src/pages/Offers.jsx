    ...
    <div className={style.offers}>
        ...
        <div className={style.offerDiv1}>
            <div>
                ...
                <div> <img src="https://cdn.modesens.com/static/img/search_keyword_icon_20180510.svg"/></div>
            </div>
            <div>
                <button>SHARE</button>
              <div>  <img src="https://cdn.modesens.com/static/img/20190805Vector.svg"/></div>
            </div>
        </div>
